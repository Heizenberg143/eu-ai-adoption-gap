...
- [x] Real-world, non-generic Eurostat dataset
- [x] Manageable dataset size for a 16 GB MacBook
- [x] More than 10 multi-dimensional analytical questions
- [x] Twelve Plotly visualizations
- [x] Jupyter notebook
- [x] HTML notebook export
- [x] Multi-tab Streamlit dashboard
- [x] PowerPoint presentation
- [x] Presentation PDF
- [x] Dataset, raw source files, codebook, and source links
- [x] Reproducible code and requirements
...
The project brief requires the final project to live in a separate repository.
